...
export function NoteCard({ note, onDelete, onToggleFavorite, onEdit }: NoteCardProps) {
      ...
      <div className="flex items-center justify-between gap-2 mb-2">
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <button
            ...
            className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-black/10 transition-colors"
          ...
          <button
            ...
            className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-black/10 transition-colors text-muted-foreground hover:text-destructive"
